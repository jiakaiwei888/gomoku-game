...
class GomokuGame {
  ...
  init() {
    try {
      ...
      this.showMessage('游戏初始化失败，请刷新页面！');
    }
  }
  ...
  handleCellClick(row, col) {
    try {
      ...
      console.error('处理格子点击时发生错误:', error);
      this.showMessage('发生错误，请刷新页面重试！');
    }
  }
